...
## Police composition
In the united state in 2020, there is roughly 50.5 % of women and the black population represent approximately 13,5% of the total population. 
```{r, echo = FALSE, message = FALSE, warning=FALSE}
Race_and_ethnicity$share <- Race_and_ethnicity$share * 100
...
In 2020, there were 538,203 violent-crime incident compared to only  276,363 in 2013. Violence is rising in the United Sates, but who is responsible of? 
...
```{r, echo = FALSE, message = FALSE, warning=FALSE}
election_percent <- election %>% select(state, percent_democrat_2016, percent_democrat_2020)

kable(election_percent) %>% kable_styling(fixed_thead = T, full_width = F, position = "left") %>% 
  row_spec(0, bold = T, italic = T, color = "white", background = "darkslategray") %>% column_spec(1, color = "white", background = "cadetblue") %>% scroll_box(height = "350px", width = "54%")
