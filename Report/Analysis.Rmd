...
In this plot, if the percentage of black people in a state is lower, the disparity between them and white people will be lower as well.
...
We can still show the total population do not have an effect on the regression again. 
