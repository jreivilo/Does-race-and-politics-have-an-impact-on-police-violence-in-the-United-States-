# Modelling
## Armed and Unarmed (Black and white)
...
```{r, echo = FALSE, message = FALSE, warning=FALSE}
regsubsets.out <-
regsubsets(Black.White.Disparity ~ percent_democrat_2016 + violent_crime_2016 + percent_black + percent_white + percent_hispanic + percent_asian + Total.Population, data=vote_rel_new,
             nbest = 1,       # 1 best model for each number of predictors
             nvmax = NULL,    # NULL for no limit on number of variables
             force.in = NULL, force.out = NULL,
             method = "exhaustive")
