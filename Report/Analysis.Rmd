...
b_pop <- data.frame(Killingsbystate[c("state","Rate..All.People.", "X..People.Killed", "Total.Population", "X..African.American","X..White", "X..Hispanic", "X..Asian", "X..Victims.Black","Rate..Black.People.","X..White", "Disparity", "Disparity.in.Rate", "Black.White.Disparity")])
b_pop <- b_pop[1:51,]
...
vote_rel_new <- vote_rel_new[c("Rate..All.People.", "Disparity.in.Rate", "Black.White.Disparity", "percent_democrat_2016", "X2016", "X..African.American", "X..White", "X..Hispanic", "X..Asian", "Total.Population")]
...
Based on the correlation table, percent_democrat_2016 is slightly correlated with violent_crime_2016. 
