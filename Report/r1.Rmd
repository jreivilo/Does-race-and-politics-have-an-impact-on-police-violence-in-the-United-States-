...
Another detail we can add is that states that are democratic are bigger and corresponds to places where there are more metropolis, business and so, more foreigners : California or New York for instance.
