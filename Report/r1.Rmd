...
### Creating new dataframe and rename columns
...
kable(election_percent) %>% kable_styling(fixed_thead = T, full_width = F, position = "left") %>% 
  ...
  scroll_box(height = "350px", width = "65%")
...
As previously stated, more state turned to be in 2020 more democrat than 2016. We can observe this small difference on the 2 maps. 
