...
## Sources 
For this research, we are using a variety of data sets gathered from both official and non-official sources. 
...
...
For this table we wanted to extract the rate of killings per year for each state and how it evolved. If possible identify whether Black or White people were more responsible of these crimes aswell compared to their population proportion.
