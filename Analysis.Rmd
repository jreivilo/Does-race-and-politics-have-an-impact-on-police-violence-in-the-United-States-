...
Black white disparity is strongly negatively correlated with violent crime in 2016. On the other side, percent democrat 2016 is positevely correlated to black and white disparity. The other variable have a small influence on the black white disparity

Percent of white is srtrongly negatively correlated to percent Democrat 2016 while percent black is positevely correlated. Black population vote more for a democrat president than the white population who prefer a republican president. 
...
boxplot(vote_rel_new$Rate..All.People., col="dodgerblue3", ylab="Rate All People", main="Boxplot Rate All People")
```
...
First of all, I removed 1 outliers (Black White Disprity = 19) of the model but I kept the second outliers (Black White Disprity = 10)
...
```
On average, the number of black people shoot by police per 125'000 inhabitant is 3.7 time higher than for white people. 

This black white disparity is positively correlated to the percent of democrat in 2016. 

Democrat state seems to killed more black than white per 125^000 inhabitant.
...
On top of that, none of the variable are significative despite some being close to.
...
Despite being the important question of our research, we are unable with these data to construct a good model. This teach us at least the disparity between black and white is way more complex to explain than with only few variables. 

Maybe, quadratic model would work better but  there is a risk to overfit the data and it become harder to interpret the model specially with cubic model or higher.  
